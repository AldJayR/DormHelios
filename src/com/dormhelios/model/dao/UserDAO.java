...
public interface UserDAO {
     ...
     * Use with caution, might return many users. Consider filtering or pagination.
     *
     ...
     * The user object should have its ID set upon successful insertion if auto-generated.
     *
     ...
     * Assumes user.getUserId() is set and valid.
     *
     ...
     * Consider soft delete (setting is_active=false) instead of hard delete.
     *
